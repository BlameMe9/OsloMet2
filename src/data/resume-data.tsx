...
export const RESUME_DATA = {
  ...
  summary: [
    "My career, educations and general interests have equipped me with comprehensive skills spanning technology, psychology, research and organizational development.",
    "My main passion lies at the intersection of psychology and technology, especially in the application of AI and technologies to solve complex challenges for real world applications.",
    "My expertise shines in environments where agility and fast-pace are important.",
    "As a leader, I emphasize transparency, sincerity, cooperation, and continuous problem-solving.",
  ],
  avatarUrl:
    "https://media.licdn.com/dms/image/v2/D4D03AQGnEDQokH4eHA/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1712494802583?e=1744848000&v=beta&t=HYiJoO4OI39uYECXIJlR9oPrTh77NOc7okkWwSgAE_8",
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Executed comprehensive laboratory experiments utilizing Virtual Reality and physiological measures, encompassing recruitment, data analysis, experimental design, and scientific writing",
    },
    {
  ...
  projects: [
    {
      ...
      description:
        "Sebastian Oltedal Thorp, Kjell S. Slupphaug, Lars Morten Rimol, Simon Lervik, Simen Kristoffer B. Hoel, Simone Grassini, 2025",
      logo: ConsultlyLogo,
      link: {
        label: "link",
    ...
    },
    {
      ...
      techStack: [
        ...
        "Deliberate Learning",
        "Public Sector",
        "Manegerial Dynamic Capabilities",
      ],
      description:
    ...
    },
    {
      ...
      techStack: ["EEG", "Virtual Reality", "Immersion"],
      description:
    ...
    },
    {
      ...
      techStack: ["Spatial Computing", "Virtual Reality", "Personality Traits"],
      description:
